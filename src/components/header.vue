<template>
    <div class="headpage">
        <div class="b-header" v-if="($route.name !== 'showPlay' )  && ($route.name !== 'dramaPlay') && ($route.name !== 'recommondPlay') && ($route.name !== 'searchList')" :style="{backgroundColor: skinColor}">
            ...
            <img src="https://i0.hdslb.com/bfs/face/2c3a364cf409a85b4c651a6afbf6ffe22208c654.jpg" @click="toggleSidebar" alt="" class="b-avatar">
        ...
        <transition name="fold">
            <div class="b-sidebar" v-if="sidebarShow">
                <div class="b-user" :style="{backgroundColor: skinColor}">
                    <img src="https://i0.hdslb.com/bfs/face/2c3a364cf409a85b4c651a6afbf6ffe22208c654.jpg" alt="">                    
