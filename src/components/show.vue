  ...
  <div class="showpage">
      ...
      <transition name="slide">
        <div class="about" v-if="isAbout" >
            ...
            <div > 
                <p class="job">个人信息: </p>
                <span class="jobDetail">school</span></br>
                <span class="jobDetail">tech</span></br>
                <span class="jobDetail">phone number</span></br>
                <span class="jobDetail">6xxxxx@qq.com</span>
            </div>
            <div>
                <p class="skill">技术栈:</p>
                <span class="skillDetail">
                    【前端】HTML/HTML5   CSS/CSS3   JavaScript(ES6,ES5)   SASS   Stylus   Vue.JS   AJAX   jQuery</br>
            ...
            <div class="desc">个人网站:
                <a href="http://horistardust.github.io">Blog</a>
            </div>
        </div>
      </transition>
...
export default {
    ...
    mounted () {
         this.axios.get('https://www.easy-mock.com/mock/594d30e98ac26d795f4516dd/bilibili/banner/bilibili/show-list').then(res => {
